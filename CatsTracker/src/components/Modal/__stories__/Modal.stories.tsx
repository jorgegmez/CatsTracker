...
storiesOf('Modal', module)
  .add('Required props', () => <Modal showModal title="Storybook label title" info="Storybook label text" textButtonOk="Storybook label ok" />)
  .add('With icon', () => (
    <Modal showModal icon={images.ICON_WARNING} title="Storybook label title" info="Storybook label text" textButtonOk="Storybook label ok" />
  ))
  .add('On press ok', () => (
    <Modal
      showModal
